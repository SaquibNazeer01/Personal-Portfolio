function loadManualProjects() {
    try {
        ...
        const projects = [
            ...
            {
                name: "Mining Game",
                description: "and addictive mining game where players click on boxes to reveal hidden treasures. Each box may be safe or contain a bomb — choose wisely! The goal is to collect as many rewards as possible without triggering a bomb.",
                status: "Completed",
        ...
        const container = document.getElementById('projects-container') || document.querySelector('.projects-section');
        if (container) {
            container.innerHTML = `
